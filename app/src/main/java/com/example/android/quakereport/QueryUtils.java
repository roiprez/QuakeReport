    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int index = 0; index < features.length(); index++){
                JSONObject earthquakeArray = features.getJSONObject(index);
                JSONObject properties = earthquakeArray.getJSONObject("properties");
                earthquakes.add(new Earthquake(properties.getDouble("mag"),properties.getLong("time"),properties.getString("place")));
            }
